...
def load_forecast(records: List[Dict]) -> None:
    """
    Load weather forecast records into PostgreSQL database.
    
    Args:
        records: List of dictionaries matching weather_forecast schema
